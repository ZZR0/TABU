...
//			System.exit(0);
	...
	public static double runbyfile(String argv[]){
		...
		//1000 is the number of itrs to stop when there is no improvement
		Layout soln= search.multiStartRandomSearch(slap, lbLayout.objective(), cpuTime, true, totalItrs, 1000);
